...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(
      ...
      MEH(KC_SPC), MT(OSM(MOD_LALT), MOD_LCTL), MT(QK_LEAD,OSM(MOD_LSFT)), TG(1)
  ),
	...
	[2] = LAYOUT_split_3x5_2(
      KT_AT, KC_LPRN, KC_LCBR, KC_LBRC, KC_QUESTION, KC_PERCENT, KC_SLASH, KC_DOLLAR, KC_CIRC, KC_EQUAL,
      KC_GT, KC_TILDE, KC_QUOTE, KC_DQUO, KC_GRAVE, KC_HASH, KC_COLON, KC_MINUS, KC_DOT, KC_ASTRR,
	...
	[3] = LAYOUT_split_3x5_2(
      ...
      TG(0), OSM(MOD_LCTL), OSM(MOD_LSFT), K_NO
  )
};
