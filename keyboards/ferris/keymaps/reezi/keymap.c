...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_ABC] = LAYOUT_split_3x5_2(
      ...
      MEH_T(KC_SPACE), _______, OSM(MOD_LSFT), TO(_SYM)
  ),
	...
	[_SYS] = LAYOUT_split_3x5_2(
      _______, _______, _______, _______, _______, _______, KC_PSCR, _______, QK_BOOTLOADER, LT(0,C_FLASH),
	...
	[_SYM] = LAYOUT_split_3x5_2(
      FR_AT, _______, _______, _______, FR_EXLM, FR_PERC, FR_SLSH, FR_DLR, FR_PIPE, FR_EQL,
      _______, _______, _______, _______, _______, FR_HASH, FR_COLN, FR_MINS, FR_DOT, FR_ASTR,
