...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_ABC] = LAYOUT_split_3x5_2(
      FR_B, FR_Y, FR_O, FR_U, FR_MINS, FR_QUES, FR_L, FR_D, FR_W, FR_V,
	...
	[_SYM] = LAYOUT_split_3x5_2(
      _______, FR_PERC, FR_ASTR, FR_PLUS, FR_MINS, FR_QUES, FR_AMPR, FR_DLR, FR_BSLS, C_BQUO,
      _______, FR_AT,   FR_HASH, C_ANBR,  FR_COMM, FR_DOT,  FR_PIPE, FR_EQL, FR_SLSH, _______,
